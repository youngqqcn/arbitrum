...
import (
	...
	"github.com/youngqqcn/arbitrum/crypto/signify"
	"github.com/youngqqcn/arbitrum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/youngqqcn/arbitrum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/youngqqcn/arbitrum/internal/version.gitDate="+env.Date)
	}
