...
```shell
go get github.com/youngqqcn/arbitrum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/youngqqcn/arbitrum/blob/master/params/config.go#L251).*
